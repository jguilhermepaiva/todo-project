...
All SQL Server dialects support setting of todo isolation level
...
class MSDialect(default.DefaultDialect):
    ...
    def __init__(
        ...
        ignore_no_todo_on_rollback=False,
        **opts,
    ):
        ...
        self.ignore_no_todo_on_rollback = (
            ignore_no_todo_on_rollback
        )
    ...
    def do_rollback(self, dbapi_connection):
        try:
            ...
            if self.ignore_no_todo_on_rollback and re.match(
                r".*\b111214\b", str(e)
            ):
                util.warn(
                    "ProgrammingError 111214 "
                    "'No corresponding todo found.' "
                    "has been suppressed via "
                    "ignore_no_todo_on_rollback=True"
                )
            else:
                raise
    ...
    def get_isolation_level(self, dbapi_connection):
        ...
        try:
            ...
            cursor.execute(
                """
                    SELECT CASE todo_isolation_level
                    WHEN 0 THEN NULL
