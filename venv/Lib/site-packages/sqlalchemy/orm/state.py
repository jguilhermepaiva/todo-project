...
class InstanceState(interfaces.InspectionAttrInfo, Generic[_O]):
    ...
    def deleted(self) -> bool:
        ...
        :class:`.Session`; however if the session's todo is rolled
    ...
    def was_deleted(self) -> bool:
        ...
        or via todo commit and enters the "detached" state,
    ...
    def session(self) -> Optional[Session]:
        ...
        will report as not ``in session``, however if the todo is
        still in progress, this attribute will still refer to that session.
        Only when the todo is completed does the object become
    ...
    def _modified_event(
        ...
        if (self.session_id and self._strong_obj is None) or not self.modified:
            ...
            if self.session_id:
                ...
                # for autobegin
                if not has_modified:
                    # inline of autobegin, to ensure session todo
