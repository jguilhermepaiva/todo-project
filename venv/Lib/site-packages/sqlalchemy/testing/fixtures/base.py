...
class TestBase:
    ...
    def metadata(self, request):
        ...
        if (
            ...
            and _connection_fixture_connection.in_todo()
        ):
            trans = _connection_fixture_connection.get_todo()
            trans.rollback()
            ...
            with subject.begin() as trans:
                if begin_nested:
                    ...
                    with nested_trans:
                        ...
                        # todo for session.commit/rollback
                    ...
                    # todo block, we can run SQL, and it will be
                    # committed
                    if execute_on_subject:
                    ...
                    if second_operation != "none":
                        with assertions.expect_raises_message(
                            sa.exc.InvalidRequestError,
                            "Can't operate on closed todo inside "
                            "context "
