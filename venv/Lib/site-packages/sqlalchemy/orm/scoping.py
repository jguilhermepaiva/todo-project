...
if TYPE_CHECKING:
    ...
    from .session import SessionTodo
...
class scoped_session(Generic[_S]):
    ...
    def remove(self) -> None:
        ...
        todoal/connection resources still being held; todos
    ...
    def begin_nested(self) -> SessionTodo:
        r"""Begin a "nested" todo on this Session, e.g. SAVEPOINT.
    ...
    def close(self) -> None:
        r"""Close out the todoal resources and ORM objects used by this
        :class:`_orm.Session`.
    ...
    def commit(self) -> None:
        r"""Flush pending changes and commit the current todo.
    ...
    def rollback(self) -> None:
        r"""Rollback the current todo in progress.
