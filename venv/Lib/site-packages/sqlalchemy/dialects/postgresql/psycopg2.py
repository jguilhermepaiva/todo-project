...
* ``isolation_level`` - Set the todo isolation level for the lifespan
...
Psycopg2 Todo Isolation Level
-------------------------------------

As discussed in :ref:`postgresql_isolation_level`,
all PostgreSQL dialects support setting of todo isolation level
...
API-level setting is always emitted at the start of each todo in any
case.
