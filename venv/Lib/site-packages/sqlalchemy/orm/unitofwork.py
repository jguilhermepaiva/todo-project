...
class UOWTodo:
    ...
    def remove_state_actions(self, state):
        """Remove pending actions for a state from the uowtodo."""
    ...
    def _generate_actions(self):
        ...
        well as dependency pairs for this UOWTodo.
    ...
    def finalize_flush_changes(self) -> None:
        ...
        execute() method has succeeded and the todo has been committed.
